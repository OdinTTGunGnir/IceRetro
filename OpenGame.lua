...
local function IntoGame_hsz()
    ...
    --登陆
    else if SearchColor.search("Login") then
        
    --开始游戏   
    else if SearchColor.search("StartGame") then
        
    --选择角色 
    else if SearchColor.search("SelectPlayer") then

    --进入游戏    
    else if SearchColor.search("Enter") then   
